...
if (message.content === '#inv') {
      message.author.send('https://discordapp.com/api/oauth2/authorize?client_id=586636276883652628&permissions=8&scope=bot').catch(e => console.log(e.stack));
